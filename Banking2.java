    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource().equals(b1)) {
            if (t1.getText().isEmpty() || (t2.getText().isEmpty()) || (t3.getText().isEmpty())
                    || (t4.getText().isEmpty()) || (t5.getText().isEmpty()) || (pw.getText().isEmpty())
                    || (t7.getText().isEmpty()) || (r1.isSelected()) || (r2.isSelected()) || (r3.isSelected())) {
                JOptionPane.showMessageDialog(null, "Data missing");
            } else {
                JOptionPane.showMessageDialog(null, "Data completed");
            }
            output.setText("name:-  " + name + "nSurname:-  " + surname + "nDiscription:-  " + discription
                    + "nGender:-  " + gender + "nAddress:- " + address + "nUser Name:- " + users + "nPass word:- "
                    + pass + "nMobile No:-" + phone);
